...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><figure><img src="@source/blogs/1_工具与框架/Windows CUDA教程：编写与运行CUDA代码/assert/b327aa862797487aa4109586a7ddecb4.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><figure><img src="@source/blogs/1_工具与框架/Windows CUDA教程：编写与运行CUDA代码/assert/3bb88085c20446b3911a7bdfa0a2399b.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<figure><img src="@source/blogs/1_工具与框架/Windows CUDA教程：编写与运行CUDA代码/assert/6ad86e71fd9646b7a5f6851cbaf82a33.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<figure><img src="@source/blogs/1_工具与框架/Windows CUDA教程：编写与运行CUDA代码/assert/618d121410344fbaadcf2cb547c33dea.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>然后点击上面运行的按钮即可，出现运行结果就证明环境安装成功！</p>
<figure><img src="@source/blogs/1_工具与框架/Windows CUDA教程：编写与运行CUDA代码/assert/ca17e5d71eb84b2785fa69ab9d671be4.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
