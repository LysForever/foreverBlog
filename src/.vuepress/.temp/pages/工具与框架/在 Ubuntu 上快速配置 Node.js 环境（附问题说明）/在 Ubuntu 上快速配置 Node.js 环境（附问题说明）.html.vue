...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><img src="@source/工具与框架/在 Ubuntu 上快速配置 Node.js 环境（附问题说明）/assets/924470e5683a420d873b5a154c0088f7.png" alt="在这里插入图片描述" loading="lazy"><br>
接着下载nodejs的安装包</p>
...
<img src="@source/工具与框架/在 Ubuntu 上快速配置 Node.js 环境（附问题说明）/assets/bc6a2bd9fa8749dca0436e17b753b32e.png" alt="在这里插入图片描述" loading="lazy"></p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><figure><img src="@source/工具与框架/在 Ubuntu 上快速配置 Node.js 环境（附问题说明）/assets/f0de85c36b6e40ca835b3d1194afd55d.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><figure><img src="@source/工具与框架/在 Ubuntu 上快速配置 Node.js 环境（附问题说明）/assets/d087a15ef3d74404884001fc856bf49c.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><figure><img src="@source/工具与框架/在 Ubuntu 上快速配置 Node.js 环境（附问题说明）/assets/b906bd895e0f4ea9ba91f7355d686b92.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<p>Vuepress没有权限写入<br>
<img src="@source/工具与框架/在 Ubuntu 上快速配置 Node.js 环境（附问题说明）/assets/e8664fa4a527482d980d264aa82f3fd5.png" alt="在这里插入图片描述" loading="lazy"><br>
修改权限</p>
